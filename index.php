...
if(isset($_POST['submit'])){
    if(!empty($_POST['ruc'])){
        ...
        if ($datos != null) { //si el json no viene null
            ...
            //echo("$json");
            echo'<br>';
            echo'<div class="c" style="position: absolute; margin-top: 10%; left: 6.3%">';
            ...
            echo '<tr style="text-align: center">'
                    ...
                    .'<td>' . '<a href="pdf/pdf.php" target="_blanck"><img src="https://www.fundacionmariaauxiliadora.org/wp-content/uploads/2017/10/pdf-icon.png" width="30" height="35" /></a>'. '</td>'
                    .'</tr>';
